#if !defined(AOC_Y2024_PUZZLE_COMMON_HPP)
#define AOC_Y2024_PUZZLE_COMMON_HPP (1)

#define AOC_Y2024_PUZZLE_CLASS_DECLARATION(day)                                                                        \
...
#endif // !defined(AOC_Y2024_PUZZLE_COMMON_HPP)
